...
parser.add_argument('--csv_name', type=str, default="testrun1", help="csv output file name")
...
parser.add_argument('-n', '--network', type=str, default="sumohangzhou1_4x4", help="network name")
